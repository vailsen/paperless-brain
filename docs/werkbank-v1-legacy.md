> **Historisch — beschreibt Werkbank v1.**
>
> v1 läuft bis Phase 7 der v2-Migration weiter (`werkbank/`), danach wird der
> Pfad entfernt. Maßgeblich für neue Arbeit ist `werkbank-architecture.md`
> (v2). Dieses Dokument bleibt, weil der laufende Code noch so gebaut ist.
...
# Anhang: v1-Bauplan (abgeschlossen)
